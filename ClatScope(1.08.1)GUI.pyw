...
default_color = 'white'  # Default text color for GUI text tags
API_KEY = "NSERT GOOGLE API KEY HERE"  # Replace with your actual keys
CX = "INSERT GOOGLE CX HERE"
...
PERPLEXITY_API_KEY = "INSERT API KEY HERE"  # Perplexity.AI API Key
RAPIDAPI_KEY = "INSERT API KEY HERE" # RapidAPI Key
...
"""
    ...
    def reverse_phone_lookup(self, phone_number):
        # (This function was not fully implemented in the original script.)
...
"""
            ...
            msg = f"[!] > An error occurred: {e}"
            self.gui_print(msg)
            messagebox.showerror("Travel Risk Assessment", f"An error occurred: {e}")
